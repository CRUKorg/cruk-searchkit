...
var CRUKSearchkitAlert = function (_SearchkitComponent) {
  ...
  _createClass(CRUKSearchkitAlert, [{
    ...
    value: function componentDidMount() {
      ...
      this.searchkit.addResultsListener(function () {
    ...
    value: function render() {
      ...
      var dismissableClass = dismissable ? ' cr-hu-alert--dismissible' : '';
      var animationClass = animation && !this.stopAnimation ? ' cr-animated-' + animation : '';
      var cssClasses = 'cr-hu-alert cr-hu-alert--' + type + dismissableClass + animationClass;
      return _react2.default.createElement(
        ...
        this.props.dismissable && _react2.default.createElement('button', {
          type: 'button',
